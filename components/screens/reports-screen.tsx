...
const PERIOD_DATA: Record<Period, {
  ...
  today: {
    ...
    topTrendDelta: 312,
    bySource: [
      { source: 'reddit', count: 38, pct: 28 },
      { source: 'x', count: 31, pct: 23 },
      { source: 'bluesky', count: 24, pct: 18 },
      { source: 'hn', count: 18, pct: 13 },
      { source: 'gdelt', count: 16, pct: 12 },
      { source: 'rss', count: 14, pct: 10 },
      { source: 'github', count: 9, pct: 7 },
    ],
  ...
  week: {
    ...
    topTrendDelta: 542,
    bySource: [
      { source: 'reddit', count: 142, pct: 28 },
      { source: 'x', count: 116, pct: 23 },
      { source: 'bluesky', count: 96, pct: 19 },
      { source: 'hn', count: 78, pct: 15 },
      { source: 'gdelt', count: 62, pct: 12 },
      { source: 'rss', count: 58, pct: 11 },
      { source: 'github', count: 39, pct: 8 },
    ],
  ...
  month: {
    ...
    topTrendDelta: 1240,
    bySource: [
      { source: 'reddit', count: 612, pct: 30 },
      { source: 'x', count: 484, pct: 24 },
      { source: 'bluesky', count: 384, pct: 19 },
      { source: 'hn', count: 298, pct: 15 },
      { source: 'gdelt', count: 234, pct: 12 },
      { source: 'rss', count: 198, pct: 10 },
